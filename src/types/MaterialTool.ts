...
(() => {
  const initial = [
    ["Wooden Nail", 0, 48, 2700, 1017, 16200, 7628, 1830, 9150, 2734],
    ["Wooden Plank", 0, 48, 3000, 1269, 18000, 9518, 2172, 10860, 3188],
    ["Wooden Hammer", 0, 48, 3600, 1561, 21600, 11708, 2663, 13315, 3852],
    ["Glass", 0, 48, 4200, 1892, 25200, 14190, 6836, 34180, 9768],
    ["Nail", 0, 48, 5700, 2691, 34200, 20183, 10423, 52115, 14622],
    ["Sand Grain Tweezers", 0, 48, 6600, 3165, 39600, 23738, 11163, 55815, 15554],
    ["Mortar and Pestle", 0, 48, 7500, 3690, 45000, 27675, 17294, 86470, 23960],
    ["Pickaxe", 0, 48, 8400, 4270, 50400, 32025, 20037, 100185, 27632],
    ["Sandpaper", 0, 48, 9900, 5249, 59400, 39368, 26954, 134770, 36968],
  ] as const;
